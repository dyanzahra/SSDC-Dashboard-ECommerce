...
def load_all_data():
    try:
        ...
        df_customers = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\customers_dataset.csv")
        df_geolocation = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\geolocation_dataset.csv")
        df_order_items = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\order_items_dataset.csv")
        df_order_payments = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\order_payments_dataset.csv")
        df_order_reviews = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\order_reviews_dataset.csv")
        df_orders = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\orders_dataset.csv")
        df_product_category_name_translation = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\product_category_name_translation.csv")
        df_products = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\products_dataset.csv")
        df_sellers = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\sellers_dataset.csv")
        df_closed_deals = pd.read_csv('D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\closed_deals_dataset.csv') # Tambahan
        df_marketing_qualified_leads = pd.read_csv("D:\Lomba\SSDC_Dashboard_Project\data\Database E-Commerce\marketing_qualified_leads_dataset.csv") # Tambahan
